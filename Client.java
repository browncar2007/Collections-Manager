    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        while (!option.equalsIgnoreCase("quit")) {
            ...
            if (option.equalsIgnoreCase("add")) {
                collectionManager.add(Pokedex.parse(console));
                System.out.println();
                ...
                System.out.println(collectionManager.contains(Pokedex.parse(console)));
                System.out.println();
                ...
                System.out.print("Type to filter: ");
                String type = console.nextLine();
                List<Pokedex> list = collectionManager.filter(type);
                System.out.println();
                if(!list.isEmpty()) {
